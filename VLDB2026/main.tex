...
%		In experiments, for attribute filtering, we construct standard attribute sets, enabling a unified comparison of algorithms in terms of index construction efficiency, query performance, and robustness. For range filtering, we also evaluate the algorithm performance across the 3 metrics through controlled variation of query ranges.
	\textcolor{orange}{In the experiments, we constructed standardized attribute and range sets for attribute filtering and range filtering, respectively, enabling a unified comparison of algorithms in terms of index construction efficiency and query performance. Furthermore, we evaluate the robustness of the algorithms across multiple dimensions, including different data distributions, platforms, and scalability on a 100M-scale dataset.}
...
%	The experimental results show consistent performance across all datasets and query ranges.
	...
	\textcolor{blue}{SeRF, ACORN and vector databases performed poorly.
		...
		The performance of vector databases in range queries is also poor, as their database systems also incorporate many other designs that can affect the algorithm's performance. Among them, Milvus performed well. PASE performs poorly on small-range queries, with recall lower than 0.1, due to its post-filtering strategy. 
	}
...
\begin{tabular}{|l|*{16}{c|}}
	...
	\textbf{Fast Index Construction} & M & M & M & M & M & G & P & M & G & P & P & P/P & \textbf{B}/\textbf{B} & G/G & P/M & P/P \\
	\textbf{Memory Constraint} & M & P & M & M & M & G & P & P & M & P & P & P/P & \textbf{B}/\textbf{B} & G/M & G/M & G/G \\
	\textbf{Large-Scale Dataset} & \textbf{B} & G & G & P & P & G & \textbf{B} & G & M & M & G & M/P & P/M & P/P & M/M & - \\
	\textbf{Multi-Modal Dataset} & \textbf{B} & G & G & P & G & M & \textbf{B} & G & M & M & G & M/M & P/M & P/P & P/P & P/P \\
	\textbf{High LID Dataset} & \textbf{B} & G & M & G & M & M & \textbf{B} & G & M & M & G & P/P & M/G & P/P & P/M & P/P \\
	\textbf{Rare Attribute \& Low Range} & \textbf{B} & P & M & G & G & G & \textbf{B} & G & P & G & M & M/M & M/M & P/P & P/P & P/P \\
	\textbf{Robust to Attribute Distribution} & G & P & P & G & G & G & - & - & - & - & - & G/- & P/- & \textbf{B}/- & P/- & P/- \\
...
\end{tabular}
	...
	\vspace{1mm}
\begin{flushleft}
	\textbf{Performance Levels:} \quad B = Best, G = Good , M = Moderate, P = Poor, - = Not Supported \\
\end{flushleft}
	\centering
