...
\end{figure}
	...
	\begin{table*}[t]
		...
		\caption{\textcolor{orange}{Recommendations}}
		\small
		...
		\resizebox{\textwidth}{!}{
			\begin{tabular}{|l|*{16}{c|}}
				\hline
				\textbf{Application Scenarios / Algorithm} & \textbf{NHQ} & \textbf{Filtered} & \textbf{Stitched} & \textbf{CAPS} & \textbf{ACORN} & \textbf{UNG} & \textbf{Puck} & \textbf{DSG} & \textbf{iRange} & \textbf{SeRF} & \textbf{UNIFY} & \textbf{Win} & \textbf{Faiss} & \textbf{Milvus} & \textbf{VBASE} & \textbf{PASE} \\
				\hline
				\textbf{Query Performance} & H & M & H &  &  &  &  &  &  &  &  &  &  &  &  &  \\
				\textbf{Index Time} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
				\textbf{High LID Dataset} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
				\textbf{Peak Memory} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
				\textbf{General-Purpose} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
				\textbf{Large-Scale Dataset} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
				\textbf{Rare Attribute \& Low Range} &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
