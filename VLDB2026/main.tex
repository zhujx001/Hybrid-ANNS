...
%	\subsection{Index Organization in Hybrid ANN Search}
	...
	\textcolor{violet}{Here, we briefly review the core concepts of these indexes and outline how attribute and range constraints are embedded to support hybrid queries functionality.}
...
%}
	...
	\begin{figure}[t]
		...
		\caption{\textcolor{violet}{Time and Space Overhead (AF)}}
...
%		\caption{Time and space overhead of index construction}
		\caption{\textcolor{violet}{Time and Space Overhead (RF)}}
