...
%	\textit{Large-Scale}: Designed for datasets with tens to hundreds of millions of vectors.
%	\textit{Multi-Modal}: Supports heterogeneous data modalities.
%	\textit{High-LID}: Robust in high local intrinsic dimensionality spaces.
%	\textit{Rare Attribute / Low Range}: For filtering with low attribute selectivity or small ranges.
%	\textit{Distribution-Robust}: Insensitive to shifts in attribute distribution.
