...
%		\end{tabular}
	...
	\begin{tabular}{|l|l|*{12}{c|}}
		...
		\multicolumn{2}{|c|}{\textbf{Characteristics/Algorithm}} & \textbf{NHQ} & \textbf{Filtered} & \textbf{Stitched} & \textbf{CAPS} & \textbf{ACORN} & \textbf{UNG} & \textbf{Puck} & \textbf{DSG} & \textbf{iRange} & \textbf{SeRF} & \textbf{UNIFY} & \textbf{Win}
		 \\ \hline
		\multirow{6}{*}{\textbf{AF}} 
