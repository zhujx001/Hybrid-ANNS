...
%	Figure~\ref{fig:rangeFilter_build_time} shows the single-threaded index construction time. 
	...
	\textcolor{orange}{For large-scale dataset, DSG only supports single-threaded construction, resulting in the longest build time.}
