...
%				\textit{Multi Thread} indicates whether the algorithm supports multi-threaded search.
	...
	\textcolor{red}{The attributes do not participate in index construction.}
	...
	To investigate this effect, we evaluate 4 AS levels (1\%, 25\%, 50\%, and 75\%) on the SIFT1M dataset \textcolor{blue}{using single-thread execution. We} compare the query performance of attribute filtering algorithms under varying AS conditions, as shown in Figure~\ref{fig:exp_5_1_1_SingleLabel_1thread}.
	...
	\textcolor{blue}{Based on the} query performance trends of different algorithms under varying AS levels, we categorize the algorithms into 3 groups:
