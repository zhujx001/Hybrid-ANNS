...
%		
		...
		\footnotesize{
			\begin{minipage}{\linewidth}
				\vspace{0.1cm}
				\textcolor{orange}{\textsuperscript{AF} Attribue-filtering,}
				\textcolor{orange}{\textsuperscript{RF} Range-filtering,}
				\textcolor{orange}{Filtered: FilteredVamana,}
				\textcolor{orange}{Stitched: StitchedVamana,}
				\textcolor{orange}{Win: WinFilter,}
				...
				\textcolor{orange}{\textit{Disk Support} indicates whether the algorithm supports disk storage,}
...
%	\textit{\textbf{Multimodel, 85 and Deep100M.}} \textcolor{red}{The fig is Figure \ref{fig:TrinityExtension——Attribution}}
	...
	\begin{figure}[t]
		...
		\caption{MultiModel}
		\label{fig:MultiModel_range} % A single label for the combined subfigure
		\end{subfigure}
