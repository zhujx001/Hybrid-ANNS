...
\begin{document}
	...
	Based on the experimental results, we provide algorithm selection recommendations for common application scenarios and highlight key challenges in the field of hybrid queries. These challenges include limited Boolean logic support, the lack of multi-attribute range filtering capabilities, the high indexing costs of graph-based methods, and the sensitivity of algorithms to data distribution. \textcolor{yellow} {Currently, few methods simultaneously support both attribute filtering and range filtering, pointing to potential directions for future research.}
...
%		\end{tabular}
	\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|l|}
		\hline
		\textbf{Item} & \textbf{NHQ} & \textbf{FilteredVamana} & \textbf{StitchedVamana} & \textbf{CAPS} & \textbf{ACORN} & \textbf{UNG} & \textbf{Puck} & \textbf{DSG} & \textbf{iRange} & \textbf{SeRF} & \textbf{UNIFY} & \textbf{WinFilter} \\
		\hline
		Base & Graph & Graph & Graph & IVF & Graph & Graph & IVF & Graph & Graph & Graph & Graph & Graph \\
		Dynamic Insert & N & Y & N & Y & Y & Y & Y & Y & N & Y & Y & N \\
		Multi Thread & N & Y & Y & Y & Y & Y & Y & N & Y & Y & Y & Y \\
		Filter Type & C & C & C & C & B & B & B & - & - & - & - & - \\
		AND & Y & N & N & Y & Y & Y & Y & - & - & - & - & - \\
		OR & N & Y & Y & N & Y & Y & Y & - & - & - & - & - \\
		Flexible Attributes & N & Y & Y & Y & Y & Y & Y & - & - & - & - & - \\
		Complex Boolean & N & N & N & N & Y & N & N & - & - & - & - & - \\
