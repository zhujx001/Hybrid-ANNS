...
\textcolor{orange}{
	As shown in Figure~\ref{fig:index_size_mb_comparison_query1}, PASE exhibits significantly larger index sizes across all supported datasets, mainly due to its reliance on a large amount of metadata. For regular-scale datasets, other methods show moderate variation. However, on large-scale dataset, the index sizes of ACORN and FilteredDiskANN increase sharply. The reason is xxx. Overall, IVF-based methods tend to produce more compact indexes.
}
