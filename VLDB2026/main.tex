...
\begin{document}
	...
	For range filtering queries, we evaluate 4 widely used real-world datasets: Deep~\cite{yandex_deep_dataset}, YT-Audio~\cite{youtube8m_dataset}, WIT~\cite{wit_dataset}, and Text2Image. Following prior work~\cite{DSG}, we use the data point ID within each dataset as its attribute. This ensures that the data is initially sorted.
