...
We conducted experiments on both datasets and analyzed the performance of various algorithms. Interestingly, our results indicate that using real attribute values has limited impact on the overall performance trends.
...
\textit{\textbf{ \textcolor{blue}{Section 4.2.1 Search peak memory.}}}
...
\textit{\textbf{ \textcolor{blue}{Section 4.3.1 Search peak memory.}}}
