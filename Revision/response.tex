...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{fig/attribute_legend.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{fig/range_legend.pdf}
...
\noindent
\textbf{Response:} 
Thank you for your feedback. We have improved the readability of the two figures in Section 4.2.3, and please see Meta R1 for details. 
...
For attribute filtering, by incorporating the YT-Audio-Real and WIT-Real datasets with their respective real-world attributes, we have revised the "Single-Attribute Building and Single-Attribute Query" experiments and amended the manuscript accordingly. It is also worth noting that in Section 4.2.2, under the "Single-Attribute Building and Single-Attribute Query" subsection, we have removed two previous datasets (Audio and GloVe) due to space constraints. The Audio dataset was removed because its smaller scale offered limited reference value. The GloVe dataset is similar in scale to SIFT1M, while LID is similar to GIST1M. \textbf{(Please see Section 4.2.1, and the "Single-Attribute Building and Single-Attribute Query" subsection in Section 4.2.2,  highlighted in blue in the revised manuscript.).}

In fact, we have conducted experiments to verify that the choice between synthetic and real-world attributes has a minimal impact on the algorithm's performance. For more details, please refer to our Response to Review 1 W1.
...
\textcolor{blue}{"For attribute filtering algorithms, factors such as the number of attributes, attribute distribution[13], and attribute  selectivity [47,52] significantly impact algorithm performance."}

[47]Jianguo Wang, Xiaomeng Yi, Rentong Guo, and et al. 2021. Milvus: A PurposeBuilt Vector Data Management System. In SIGMOD Conference. ACM, 2614-2627.

[52]Chuangxian Wei, Bin Wu, Sheng Wang, Renjie Lou, Chaoqun Zhan, Feifei Liand Yuanzhe Cai. 2020.AnalyticDB-V: A Hybrid Analytical Engine TowardsOuery Fusion for Structured and Unstructured Data. Proc. VLDB Endow. 13, 12(2020),3152-3165.
