...
Section 4.2.4: \textcolor{blue}{
	"We conducted experiments on the text2image-mix dataset. This dataset contains both image and text vectors. It is a more complex multimodal dataset. As shown in Figure 9a, although the queries are more complex, UNG and NHQ still perform the best. CAPS is the next best.
