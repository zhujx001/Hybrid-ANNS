...
\noindent
\textbf{Response:} 
We sincerely apologize for the misuse of notation in Definition 2.3. Thank you for pointing it out. This has been corrected in the revised version. (Please see Definition 2.3 in Section 2.1, highlighted in blue in the revised manuscript)
...
\noindent
\textbf{Response:} 
Thank you for the suggestion! Since there are multiple methods, listing all URLs in Section 4.1 would be overwhelming. Instead, we have added the corresponding URLs in footnotes on the relevant pages throughout the paper. (Please see the relevant footnotes in Section 3 in the revised manuscript)
