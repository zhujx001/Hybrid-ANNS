...
\noindent
\textbf{Response:} 
Thank you for your suggestion. We have added relevant experiments conducted on different servers in Section 4.2.4 and 4.3.4. The results show that differences in server configurations have little impact on the ranking of the methods. For more details, please refer to our response Meta R4.
%%%%%%%%%%%%%%%%%%%%%% W3 %%%%%%%%%%%%%%%%%%%%%%
...
\noindent
\textbf{Response:} 
Thank you for your suggestion. We cited these two papers in the introduction to show that there are several papers that study attribute selectivity. In practice, attribute selectivity are indeed widely used in real-world scenarios. For example, if you need to query data with a very small proportion of a certain attribute, choosing a better algorithm will greatly improve the search effect. There are also some databases with practical applications that mention attribute selectivity, such as Milvus and AnalyticDB-V. We have replaced the two references ([12] and [36]) with more comprehensive and accurate references ([47] and [52]). \textbf{(Please see Section 1.1, highlighted in blue in the revised manuscript.)}
 

\textcolor{blue}{"For attribute filtering algorithms, factors such as the number of attributes, attribute  selectivity [47,52] significantly impact algorithm performance."}
