...
\begin{table*}[htbp]
	...
	\vspace{1mm}
	\begin{flushleft}
		\textbf{Performance Levels:}  \textbf{S} = Strongest performance, S = Strong performance, M = Medium performance, W = Weak performance, - = Not Supported \quad
		\textbf{Recommendation:} \faCheck = Recommended, \faTimes = Not Recommended
	\end{flushleft}
